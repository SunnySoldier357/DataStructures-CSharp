...
namespace QueueClass
{
    public class Queue<T>
    {
        ...
        /// <summary>
        /// <para>
        /// Returns the next item that would be returned if <see cref="Dequeue"/>
        /// were called. The queue is left unchanged. An
        /// <see cref="InvalidOperationException"/> is thrown if the queue is empty.
        /// </para>
        /// <para>
        /// Performance: O(1)
        /// </para>
